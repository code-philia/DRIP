...
--output_dir meta-llama/Llama-3.2-1B-Instruct
--num_train_epochs 7
...
# Adv Train ISE
```bash
python -m torch.distributed.run --nproc_per_node=4 --master_port=29951 train_ise.py
--model_name_or_path meta-llama/Llama-3.2-1B
--data_path datasets/alpaca_data_cleaned.json
--output_dir meta-llama/Llama-3.2-1B-SpclSpclSpcl_NaiveCompletion-ise
--num_train_epochs 7
--per_device_train_batch_size 4
--per_device_eval_batch_size 1
--gradient_accumulation_steps 8
...
--bf16 True
--dataloader_num_workers 4
--extra_config_yaml_path training/config/Llama-3.2-1B-SpclSpclSpcl_NaiveCompletion-ise.yaml
```
...
--model_name_or_path meta-llama/Llama-3.2-1B
--data_path datasets/alpaca_data_cleaned.json
--output_dir meta-llama/Llama-3.2-1B-SpclSpclSpcl_NaiveCompletion-instsep
--num_train_epochs 7
--per_device_train_batch_size 4
--per_device_eval_batch_size 1
--gradient_accumulation_steps 8
...
--bf16 True
--dataloader_num_workers 4
--extra_config_yaml_path training/config/Llama-3.2-1B-SpclSpclSpcl_NaiveCompletion-instsep.yaml
```
...
--model_name_or_path meta-llama/Llama-3.2-1B
--data_path datasets/alpaca_data_cleaned.json
--output_dir meta-llama/Llama-3.2-1B-SpclSpclSpcl_NaiveCompletion-instfuse
--num_train_epochs 7
--per_device_train_batch_size 4
--per_device_eval_batch_size 1
--gradient_accumulation_steps 8
