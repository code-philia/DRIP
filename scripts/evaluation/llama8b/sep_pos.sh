...
case "$MODEL_PATH" in
    ...
    *instfuse*)               EXTRA_FLAGS="--customized_model_class LlamaForCausalLMFuse" ;;
    *ise*)                    EXTRA_FLAGS="--customized_model_class LlamaForCausalLMMoE" ;;
    *possep*)                 EXTRA_FLAGS="--customized_model_class LlamaForCausalLMMoEV2" ;;
esac
...
task0() { CUDA_VISIBLE_DEVICES=$DEV3 python -m testing.sep.test_sep $COMMON_ARGS --attack stress_repeat_6; }
task1() { CUDA_VISIBLE_DEVICES=$DEV4 python -m testing.sep.test_sep $COMMON_ARGS --attack stress_repeat_12; }
