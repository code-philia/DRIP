...
from gcg.replace_gcg import GCGConfig, run
from config import (
    DELIMITERS,
    PROMPT_FORMAT,
    SYS_INPUT,
...
if __name__ == "__main__":
    ...
    llm_inputs = []
    for i, d in tqdm(enumerate(data[3:6]), "Attacking samples..."):
        d_item = deepcopy(d)
        # gcg attack
